...
public class CircleDraw implements Sprite {
    ...
    /**
     *
     * @param x x value of center point of the ball.
     * @param y y value of center point of the ball.
     * @param radius ball's radius.
     * @param color ball's color.
     * @param fill boolean param, true if ball is filled and false if ball is
     *             a circle.
     */
